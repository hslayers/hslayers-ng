...
update-ng:
	npm run ng update @angular/common @angular/compiler @angular/core @angular/forms @angular/localize @angular/cdk @angular/material @angular/platform-browser @angular/platform-browser-dynamic @angular/compiler-cli  @angular/cli @angular-builders/custom-webpack ng-packagr
