...
describe('add-layers-vector', () => {
  let component: HsDataVectorComponent;
  let fixture: ComponentFixture<HsDataVectorComponent>;
  ...
  beforeEach(() => {
    ...
    const bed = TestBed.configureTestingModule({
      ...
      declarations: [HsDataVectorComponent],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(HsDataVectorComponent);
