...
import {HsDataUrlWmsService} from '../../url/wms/data-url-wms.service';
...
@Component({
  selector: 'hs-data-file-shp',
  templateUrl: './data-file-layer.directive.html',
})
export class HsDataFileShpComponent implements OnInit {
  abstract: string;
  ...
  constructor(
    public HsDataFileShpService: HsDataFileShpService,
  ...
  add(): void {
    ...
    this.HsDataFileShpService
      ...
      .then((descriptor) => {
        ...
        this.HsDataUrlWmsService.addService(
          descriptor.wms.url,
          undefined,
          this.name,
          undefined,
