...
export class HsLayerUtilsService {
   ...
   */
  layerIsZoomable(layer: Layer<Source, any>): boolean {
   ...
   */
  layerIsStyleable(layer: Layer<Source, any>): boolean {
    if (typeof layer == 'undefined') {
      return false;
    }
    if (
   ...
   */
  isLayerQueryable(layer: Layer<Source, any>): boolean {
   ...
   */
  getLayerTitle(layer: Layer<Source, any>): string {
  ...
  // todo
  getURL(layer: Layer<Source, any>): string {
   ...
   */
  isLayerWMS(layer: Layer<Source, any>): boolean {
    if (
  ...
  // todo
  isLayerWMTS(layer: Layer<Source, any>): boolean {
    if (
      this.HsUtilsService.instOf(layer, TileLayer) &&
  ...
  isLayerXYZ(layer: Layer<Source, any>): boolean {
    if (
      this.HsUtilsService.instOf(layer, TileLayer) &&
  ...
  isLayerArcgis(layer: Layer<Source, any>): boolean {
    if (
      this.HsUtilsService.instOf(layer, TileLayer) &&
  ...
  getLayerSourceFormat(layer: Layer<Source, any>): FeatureFormat {
   ...
   */
  isLayerGeoJSONSource(layer: Layer<Source, any>): boolean {
   ...
   */
  isLayerTopoJSONSource(layer: Layer<Source, any>): boolean {
    if (
   ...
   */
  isLayerKMLSource(layer: Layer<Source, any>): boolean {
   ...
   */
  isLayerGPXSource(layer: Layer<Source, any>): boolean {
   ...
   */
  isLayerInManager(layer: Layer<Source, any>): boolean {
    return (
  ...
  getLayerParams(layer: Layer<Source, any>): any {
    const src = layer.getSource();
    if (this.HsUtilsService.instOf(src, ImageWMS)) {
  ...
  updateLayerParams(layer: Layer<Source, any>, params: any): void {
    const src = layer.getSource();
    if (this.HsUtilsService.instOf(src, ImageWMS)) {
   ...
   */
  hasLayerTitle(layer: Layer<Source, any>): boolean {
   ...
   */
  isLayerEditable(layer: Layer<Source, any>): boolean {
   ...
   */
  getLayerName(layer: Layer<Source, any>): string {
    if (
      layer === undefined ||
      (getShowInLayerManager(layer) !== undefined &&
   ...
   */
  isLayerDrawable(layer: Layer<Source, any>): boolean {
    return (
      this.HsUtilsService.instOf(layer, VectorLayer) &&
      layer.getVisible() &&
   ...
   */
  isLayerClustered(layer: Layer<Source, any>): boolean {
