...
<body>
  ...
  <style>
    ...
    <img id='page-fliper' title="Use this to lock the screen" src='img/jantonalcor-corner-up2.png'  draggable="false" style='position: absolute; bottom: 0; left: 0; z-index: 1001; opacity: 0.6;' />
    <script>
       var $dragging = null;
