...
export class HsDialogContainerComponent {
  @ViewChild(HsDialogHostDirective, {static: true}) dialogHost: HsDialogHostDirective;
  interval: any;
    constructor(private HsDialogContainerService:HsDialogContainerService, private componentFactoryResolver: ComponentFactoryResolver){
     this.HsDialogContainerService.dialogObserver.subscribe((item:HsDialogItem) => {
