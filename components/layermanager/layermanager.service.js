...
export default ['$rootScope', 'hs.map.service', 'Core', 'hs.utils.service', 'hs.utils.layerUtilsService', 'config', 'hs.layermanager.WMSTservice',
  'hs.wmts.getCapabilitiesService', 'hs.wfs.getCapabilitiesService', 'hs.wms.getCapabilitiesService', 'hs.layerEditorVectorLayer.service', '$timeout',
  function ($rootScope, OlMap, Core, utils, layerUtils, config, WMST, WMTSgetCapabilitiesService, WFSgetCapabilitiesService, WMSgetCapabilitiesService, vectorLayerService, $timeout) {
    const me = {};
    ...
    function layerAdded(e) {
      ...
      if (layerUtils.isLayerVectorLayer(layer) && layer.get('cluster')) {
        vectorLayerService.cluster(true, layer, '40');
      }
