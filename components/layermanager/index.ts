 ...
 */
  ...
  angular
     ...
     */
    .service('HsLayermanagerWmstService', downgradeInjectable(HsLayerManagerWmstService))
     ...
     */
    .service('HsLayermanagerMetadata', downgradeInjectable(HsLayerManagerMetadataService))
     ...
     */
    .directive('hs.layermanager.folderDirective', downgradeComponent({ component: HsLayerManagerFolderComponent}))
     ...
     */
    .directive('hs.layerEditor', downgradeComponent({ component:HsLayerEditorComponent}))
     ...
     */
    .service('HsLayerEditorVectorLayerService', downgradeInjectable(HsLayerEditorVectorLayerService))
     ...
     * @description Panel for editing selected layer parameters
     */
    .directive('hs.layermanager.gallery', downgradeComponent({ component:HsLayerManagerGalleryComponent}))
