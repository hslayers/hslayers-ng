...
define(['angular', 'app', 'map', 'ol', 'utils', 'ows.wms', 'dragdroplists', 'status_creator'], function (angular, app, map, ol) {
    angular.module('hs.layermanager', ['hs.map', 'hs.utils', 'hs.ows.wms', 'dndLists', 'hs.status_creator'])
         ...
         */
        .directive('hs.layermanager.layerlistDirective.deprecated', ['$compile', function ($compile) {
            return {
         ...
         * Example
            ...
            * ```
         */
        .directive('hs.layermanager.removeAllDialogDirective.deprecated', function () {
            return {
         ...
         */
        .directive('hs.layermanager.folderDirective.deprecated', ['$compile', function ($compile) {
            return {
    ...
    .controller('hs.layermanager.controller', ['$scope', 'config', 'hs.map.service', 'hs.layermanager.service', '$rootScope', '$mdDialog',
    ...
    .controller('hs.layermanager.controller.deprecated', ['$scope', 'hs.map.service', 'config', '$rootScope', 'Core', '$compile', 'hs.utils.service', 'hs.styler.service', 'hs.ows.wms.service_capabilities', 'hs.status_creator.service', 'hs.layermanager.service', 'hs.layermanager.WMSTservice', 'hs.utils.layerUtilsService',
