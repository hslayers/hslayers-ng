                ...
                function ($rootScope, OlMap, Core, config, utils, nonwmsservice) {
                    ...
                    this.loadDataset = function (dataset) {
                        switch (dataset.type) {
                            case "micka":
                                ...
                                var text = angular.isDefined(me.data.query.textFilter) && me.data.query.textFilter.length > 0 ? me.data.query.textFilter : me.data.query.filter;
                                var query = [
                    ...
                    */
                    ...
                    this.checkAdvancedMicka = function () {
                        ...
                        if (me.data.query.title != '') me.data.query.text_filter = me.data.query.title;
                    }
