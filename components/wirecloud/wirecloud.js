            ...
            .service("WireCloud", ['$rootScope', 'OlMap', 'wirecloud_data_consumer',
                function($rootScope, OlMap, wirecloud_data_consumer) {
                  ...
                  if(typeof MashupPlatform !== 'undefined'){
                      ...
                      MashupPlatform.wiring.registerCallback("map_info_slot", function(data){console.log("map_info_slot", data)});
                      MashupPlatform.wiring.registerCallback("location_info_slot", function(data){console.log("location_info_slot", data)});
                  } else return;
                }
            ])
