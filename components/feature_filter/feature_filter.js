...
* @description TODO
*/
module.service('hs.feature_filter.service', ['$rootScope', 'hs.map.service', 'hs.layermanager.service', 'Core', 'hs.utils.service', 'config', function ($rootScope, OlMap, LayMan, Core, utils, config) {
    var me = {
...
* @description TODO
*/
module.controller('hs.feature_filter.controller', ['$scope', 'hs.map.service', 'Core', 'hs.feature_filter.service', 'hs.layermanager.service', 'config',
...
* @description TODO
*/
module.controller('hs.feature_list.controller', ['$scope', 'hs.map.service', 'Core', 'hs.feature_filter.service', 'hs.layermanager.service', 'config',
    function ($scope, OlMap, Core, service, LayMan, config) {
        window.scope = $scope;
        $scope.map = OlMap.map;
        $scope.LayMan = LayMan;
