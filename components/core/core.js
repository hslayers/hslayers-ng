...
angular.module('hs.core', ['hs.map', 'gettext', 'hs.drag', 'hs.layout', 'hs.utils'])
  /**
   * @module hs.core
   * @name Core
   * @ngdoc service
   ...
   */
  .factory('Core', ['$rootScope', '$controller', '$injector', '$window', 'hs.map.service', 'config', '$timeout', 'hs.layout.service', '$log', '$document', 'hs.utils.service',
