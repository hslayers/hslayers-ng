...
export default ['$http', 'hs.map.service', 'hs.utils.service', '$rootScope', function ($http, OlMap, utils, $rootScope) {
    ...
    */
    this.service2layers = function (caps) {
        var service = caps.layers;
        var srss = caps.spatialReference.wkid;
        var image_formats = caps.supportedImageFormatTypes.split(',');
        var query_formats = (caps.supportedQueryFormats ? caps.supportedQueryFormats.split(',') : []);
